        ...
        <div className="w-full p-6">
            ...
            <div className="grid grid-cols-1 gap-4 mt-6 md:grid-cols-3">
                <div className="p-4 bg-white border rounded-lg shadow-md">
                    <p className="flex items-center gap-2 text-gray-600"><FaStore className="text-green-600" /> Total Shops</p>
                ...
                <div className="p-4 bg-white border rounded-lg shadow-md">
                    <p className="flex items-center gap-2 text-gray-600"><FaUsers className="text-green-600" /> Total Users</p>
            ...
            <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-4 mt-3">
                    <button className="px-4 py-2 text-white bg-green-500 rounded-md">Add New Shop</button>
                    <button className="px-4 py-2 text-white bg-yellow-500 rounded-md">Manage Fertilizers</button>
                    <button className="px-4 py-2 text-white bg-gray-500 rounded-md">View All Orders</button>
                    <button className="px-4 py-2 text-white bg-red-500 rounded-md">View All Users</button>
                </div>
            </div>
        </div>
    );
